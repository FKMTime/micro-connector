...
pub enum TestStep {
    ...
    ResetState,
    SolveTime(u64),
    Button { name: String, time: u32 },
    DelegateResolve { should_scan_cards: bool, penalty: i64, value: u64 },

    // verifiers
    VerifySolveTime { time: u64, penalty: i64 },
    VerifyDelegateSent { time: Option<u64>, penalty: Option<i64> }
}
